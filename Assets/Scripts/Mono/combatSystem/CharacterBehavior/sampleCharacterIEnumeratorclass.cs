...
namespace oct.ObjectBehaviors
{
    ...
    public class sampleCharacterIEnumeratorclass : MoveableControlCoroutine
    {
        ...
        public GameObject ChargeAtkBullet;
       ...
       public void SetFly(Vector3 vector3)
        ...
        public IEnumerator ChargedAtk()
        {
            ...
            PlayerControllerr.createBullet(ChargeAtkBullet, bulletPosition, 0.07f);
        ...
        public IEnumerator hit1()
        {
         ...
         //   PlayerControllerr.speed = 5;
            ...
            {
                PlayerControllerr.createBullet(BoostAtk1Bullet, bulletPosition, 0.07f);
            }
        ...
        public IEnumerator dash()
        {
            ...
            yield return null;
            PlayerControllerr.speed = 0;
            Vector3 target = new Vector3((PlayerControllerr.direction * DashDistance ).x,0, (PlayerControllerr.direction * DashDistance).y);
